...
build_dir = os.path.join(current_dir, "cmake-build-debug")
...
def main():
    try:
        ...
        board.configurePort(pci2321.Port.P2A, pci2321.Dir.Output) # For POWER
        board.configurePort(pci2321.Port.P1C, pci2321.Dir.Output) # For all 4 BRAKES
        print("Ports configured successfully.\n")
        board.writePort(pci2321.Port.P1A, 0)
        board.writePort(pci2321.Port.P1B, 0)
        board.writePort(pci2321.Port.P1C, 0)
        board.writePort(pci2321.Port.P2A, 0)
